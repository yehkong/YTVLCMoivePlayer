...
- (IBAction)audioTrackButtonAction:(UIButton *)sender {
    ...
    UIActionSheet* actionSheet = [[UIActionSheet alloc]initWithTitle:@"Audio track" delegate:self cancelButtonTitle:@"Cancel" destructiveButtonTitle:nil otherButtonTitles:nil];
